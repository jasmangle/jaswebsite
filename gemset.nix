{
  ...
  jekyll-remote-theme = {
    ...
    source = {
      ...
      rev = "5e4efebf662a08dea4af97cb77ffb11e4e02ac9d";
      sha256 = "0m8j6h4rnaspvwziwql4lzk4a4fg5fcaasjmzby3l38wqin9kci0";
      type = "git";
      url = "git@github.com:jasmangle/jekyll-remote-theme.git";
    };
    version = "0.4.3";
  };
